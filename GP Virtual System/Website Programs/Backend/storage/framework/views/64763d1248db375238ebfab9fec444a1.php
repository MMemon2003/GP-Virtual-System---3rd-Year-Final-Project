        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <img src="<?php echo e(asset('images/Healthcare GIF.gif')); ?>" alt="Healthcare GIF" class="img-fluid">
                </div>
                <div class="col-lg-6">
                    <h2>About Us</h2>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                           ...
                           <a href="<?php echo e(route('patients.medical.reports')); ?>" class="btn btn-primary btn-sm">Access Medical Reports</a>
...
<?php /**PATH C:\laragon\www\MyLaravelProject\resources\views/GPVirtualSystem.blade.php ENDPATH**/ ?>