...
<main class="container mt-5">
    ...
    <form action="<?php echo e(route('patient.login')); ?>" method="POST" class="mx-auto" style="max-width: 400px;">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\MyLaravelProject\resources\views/patient-login.blade.php ENDPATH**/ ?>