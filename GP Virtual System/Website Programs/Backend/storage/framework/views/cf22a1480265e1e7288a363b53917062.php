...
<body>
  <header class="header">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container">
        <!-- logo and name of the header -->
        <a class="navbar-brand" href="#">
          <img src="<?php echo e(asset('images/gp_logo.png')); ?>" alt="Logo" class="header-logo">
  ...
  <body>
        ...
        <div class="col-lg-12">
          ...
          <div class="box mb-4">
            <div class="text-center">
              ...
              <hr>
              <p>
                The Current Report is utilized during virtual appointments between patients and GPs or doctors. <br>
                It can be accessed via the IP address and contains live updates of vital signs such as body
                temperature, heart rate, and blood pressure, along with the patient's date of birth and medical ID.
              </p>
              <!-- Button to navigate to current report section -->
    ...
    <!-- Section for displaying current medical report data-->
      ...
      <div class="container">
        ...
        <form id="current-report-form">
          <div class="form-group">
            <label for="current-patient-name">Your Name:</label>
            <input type="text" class="form-control" id="patient-name" placeholder="Enter Name" required>
          </div>
          <div class="form-group">
            <label for="current-patient-id">Patient ID:</label>
            <input type="text" class="form-control" id="patient-id" placeholder="Enter ID" required>
          </div>
          <div class="form-group">
            <label for="current-phone-number">Phone Number:</label>
            <input type="text" class="form-control" id="phone-number-input" placeholder="Enter Phone" required>
          </div>
          <div class="form-group">
            <label for="current-date-of-birth">Date of Birth:</label>
            <input type="text" class="form-control" id="dob-input" placeholder="Enter DOB" required>
      ...
      <div class="col-lg-12">
        <div class="box mb-4">
          <div class="text-center">
            ...
            <hr>
            <p>
              The Yearly Reports provide a comprehensive overview of your medical history for each year. <br>
              They can also be accessed via an IP Address and contain accurate medical information spanning from
              2024 to 2019, including details such as Patients name, Medical ID and date of birth
            </p>
            <!-- Button to navigate to yearly reports section -->
    ...
    <!-- Section to display the yearly medical reports data -->
    <section id="yearly-reports" style="display: none;">
      <div class="container">
        <h2 class="text-center">Yearly Medical Reports</h2>
        <div class="row">
          <div class="col-lg-6">
            <!-- Form for generating yearly medical report -->
            <form action="sensor_handle.php" id="current-report-form" method="post">
              <div class="form-group">
                <label for="patient-name">Your Name:</label>
                <input type="text" class="form-control" id="patient-name" placeholder="Enter the Patient's name" required>
              </div>
              <div class="form-group">
                <label for="patient-id">Patient ID:</label>
                <input type="text" class="form-control" id="patient-id" placeholder="Enter the Patient's ID" required>
              </div>
              <div class="form-group">
                <label for="phone-number">Phone Number:</label>
                <input type="text" class="form-control" id="phone-number-input" placeholder="Enter Patient's phone number"
                  required>
              </div>
              <div class="form-group">
                <label for="date-of-birth">Date of Birth:</label>
                <input type="text" class="form-control" id="date-of-birth-input" placeholder="Enter Patient's date of birth"
                  required>
              </div>
              <div class="form-group">
                <label for="year">Select Year:</label>
                <!-- List of available years for the medical report -->
      ...
      <div class="col-lg-12">
        <div class="box mb-4">
          <div class="text-center">
            ...
            <hr>
            <p>
              The Prescriptions section is primarily for the patient's assigned GP. <br>
              The form will include information about the patient, diagnosis, and treatment required following any
              specific illness observed during the virtual meeting with the health gadget.
            </p>
            <!-- Button to navigate to prescriptions section -->
  ...
  <!-- Section to display prescriptions data -->
  <section id="prescriptions" style="display: none;">
    <div class="container">
      <h2 class="text-center">Prescriptions</h2>
      <div class="row">
        <div class="col-lg-6">
          <!-- Form for generating prescription -->
          <form action="sensor_handle.php" method="post">
            <div class="form-group">
  ...
  <!-- Container for displaying prescription content -->
...
<?php /**PATH C:\laragon\www\MyLaravelProject\resources\views/PatientsMedicalReports.blade.php ENDPATH**/ ?>