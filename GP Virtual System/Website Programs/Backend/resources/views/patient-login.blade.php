...
<head>
    ...
    <title>Patient Login - GP Virtual Monitoring System</title>
...
<header class="header">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <img src="{{ asset('images/gp_logo.png') }}" alt="Logo" class="header-logo mr-2">
            <a class="navbar-brand mx-auto" href="#">GP Virtual Monitoring System</a>
            <img src="{{ asset('images/gp_logo.png') }}" alt="Logo" class="header-logo ml-2">
        </div>
    </nav>
</header>
...
<main class="container mt-5">
    ...
    <form action="{{ route('patient.login') }}" method="POST" class="mx-auto" style="max-width: 400px;">
        @csrf
