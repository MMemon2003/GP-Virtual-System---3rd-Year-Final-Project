...
<div class="container_main">
    <div class="row">
        <div class="col-lg-12">
            ...
            <button onclick="button" class="white-button" onclick="showPatientForm()">Patient</button>
            <button onlink="button" class="white-button" onclick="showDoctorForm()">GP/Doctor</button>
        </div>
...
<div id="patientForm" style="display: none;">
     ...
     <form action="{{ route('patient.login') }}" method="post">
         ...
         <input type="password" id="patientPassword" name="password"><br><br>
...
<!-- Doctor Login Form -->
 <div id="doctorForm" style="display: none;">
     ...
     <form action="{{ route('doctor.login') }}" method="post">
         ...
         <input type="text" id="doctorName" name="name"><br><br>
         <label for="medicalID">Medical ID:</label>
         <input type="text" id="medicalID" name="medicalID"><br><br>
         <label for="doctorPassword">Password:</label>
         <input type="password" id="doctorPassword" name="password"><br><br>
         <button type="submit">Login</button>
     </form>
 </div>
