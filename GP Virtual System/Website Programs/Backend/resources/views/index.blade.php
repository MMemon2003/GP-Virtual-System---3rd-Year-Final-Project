...
<header class="header">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <img src="{{ asset('images/gp_logo.png') }}" alt="Left Image" class="header-image mr-2">
            <a class="navbar-brand mx-auto" href="#">GP Virtual Monitoring System</a>
            <img src="{{ asset('images/gp_logo.png') }}" alt="Right Image" class="header-image ml-2">
        </div>
    </nav>
</header>
...
<div class="container_main text-center mt-5">
    ...
    <div class="mt-4">
        ...
        <a href="{{ route('patient.index') }}" class="btn btn-primary btn-lg mx-2">Patient</a>
        <a href="{{ route('doctors.index') }}" class="btn btn-success btn-lg mx-2">GP/Doctor</a>
    </div>
</div>
